<x-template>
    <div class="container my-2">
        ...
        <form action="/sea-offer/store/{{$request->id}}" method="post">
            @csrf
            <div class="mb-2">
            ...
            <div class="mb-2">
                <div class="form-outline">
                    <label class="form-label mb-1">Date of Loading</label>
                    <input class="form-control" name="date_of_loading" type="date" value="{{ old('date_of_loading') }}" required />
                </div>
            </div>
            <div class="mb-3">
                <div class="form-outline">
                    <label class="form-label mb-1">Date of Discharge</label>
                    <input class="form-control" name="date_of_discharge" type="date" value="{{ old('date_of_discharge') }}" required />
                </div>
            </div>
